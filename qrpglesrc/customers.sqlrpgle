...
// ------------------------------------------------------------------------------------
dcl-proc Customers_ByName_Open export;

    dcl-pi Customers_ByName_Open ind end-pi;

    exec sql
        declare Customers_ByName_Cur cursor for
        select id, descrip
        from clv1.customers
        order by descrip, id;

    exec sql
        open Customers_ByName_Cur;
...
// ------------------------------------------------------------------------------------
dcl-proc Customers_ByName_FetchNext export;

    dcl-pi Customers_ByName_FetchNext likeds(customer_t) end-pi;

    dcl-ds customer likeds(customer_t);

    exec sql
        fetch next from Customers_ByName_Cur
        into 
            :customer.id,
            :customer.descrip; 
...
// ------------------------------------------------------------------------------------
dcl-proc Customers_ByName_Close export;

    dcl-pi Customers_ByName_Close end-pi;

    exec sql
        close Customers_ByName_Cur;
